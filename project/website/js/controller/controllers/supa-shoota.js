...
{
  x -= $(this._container).offset().left;
  y -= $(this._container).offset().top;
...
window.onload = function() {
    ...
    $("body").append("<div class='left-stick' style='float: left; width: 50%; height: 100%;'></div>");
    $("body").append("<div class='right-stick' style='float: right; width: 50%; height: 100%;'></div>");
